"""   
        Abstraction:
            # The process of hiding complex implementation details of a class and  only
            by showing essential features to the user is known as abstracton.

            # We can achieve abstraction by using:
                1. abstract class
                2. interface:
                        Note: python does not support interface, but using abstract class we can perform interface.
                        It means, if we create all the abstract methods in the abstract class, then it act as interface.
